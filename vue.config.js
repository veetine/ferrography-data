...
const name = defaultSettings.title || 'XHLMALL' // page title
  ...
  pluginOptions: {
    electronBuilder: {
      builderOptions: {
        ...
        'productName': 'ferrography-data', // 项目名，也是生成的安装文件名，即aDemo.exe
        'directories': {
          'output': './dist_electron' // 输出文件路径
        },
        'publish': [{
          'provider': 'generic',
          'url': 'https://update.xhlroi.com/hydra/hydra_pc/'
          // 'url': '  http://update.xhlroi.com/apollopc/'
          // 'url': 'http://xhh.update.xhh.com/dplusupdate/'
